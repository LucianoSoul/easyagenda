...
export async function authMiddleware(request, _reply) {
    ...
    const { data: appUser, error: appUserError } = await supabaseAdmin
        ...
        .maybeSingle();
    if (appUserError) {
        throw new AppError(500, "USER_CONTEXT_ERROR", "Nao foi possivel carregar o contexto do usuario.");
    }
    if (!appUser) {
        throw new AppError(403, "USER_NOT_LINKED", "Usuario autenticado sem vinculo na aplicacao.");
    }
