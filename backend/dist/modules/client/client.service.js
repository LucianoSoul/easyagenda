...
export class ClientService {
    clientRepository;
    constructor(clientRepository = new ClientRepository()) {
        this.clientRepository = clientRepository;
    }
    async getDashboard(input) {
        const nowIso = new Date().toISOString();
        const [upcomingConfirmedCount, pendingPaymentCount, cancelledOrPastCount, nextAppointments] = await Promise.all([
        ...
        return {
            ...
            nextAppointments: nextAppointments.map((appointment) => this.mapAppointmentSummary(appointment))
        };
    }
